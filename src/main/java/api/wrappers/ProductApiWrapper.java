...
public class ProductApiWrapper extends CommonApiWrapper {
    ...
    public Products getProductsById(Products content, String productId) {

        String endpoint = String.format("%s/catalog/products/%s", url, productId);
        return (Products) get(content, endpoint, headers);
    }
