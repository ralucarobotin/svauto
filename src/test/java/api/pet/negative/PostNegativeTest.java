...
public class PostNegativeTest {
    ...
    private void VerifyErrorWhenCreatingAPetWithInvalidId(){
        ...
        Assert.assertEquals(petApiWrapper.getPostPetResponseStatus(), HttpStatus.SC_NOT_FOUND, "The pet Id " + postResponsePet.getId()
                + ", is invalid");
    }
    ...
    private void VerifyErrorWhenCreatingAPetWithEmptyCategory(){
        ...
        Assert.assertEquals(petApiWrapper.getPostPetResponseStatus(), HttpStatus.SC_OK, "The pet category " + postResponsePet.getCategory()
                + ", is empty");
    }
    ...
    private void VerifyErrorWhenCreatingAPetWithINullCategoryId(){
        ...
        Assert.assertEquals(petApiWrapper.getPostPetResponseStatus(), HttpStatus.SC_OK, "The pet category id "
    ...
    private void VerifyErrorWhenCreatingAPetWithEmptyCategoryName(){
        ...
        Assert.assertEquals(petApiWrapper.getPostPetResponseStatus(), HttpStatus.SC_OK, "The pet category name " +
    ...
    private void VerifyErrorWhenCreatingAPetWithEmptyName(){
        ...
        Assert.assertEquals(petApiWrapper.getPostPetResponseStatus(), HttpStatus.SC_OK, "The pet name " + postResponsePet.getName()
                + ", is empty");
    }
    ...
    private void VerifyErrorWhenCreatingAPetWithEmptyTag(){
        ...
        Assert.assertEquals(petApiWrapper.getPostPetResponseStatus(), HttpStatus.SC_OK, "The pet tag " + postResponsePet.getTags()
                + ", is empty");
    }
    ...
    private void VerifyErrorWhenCreatingAPetWithINullTagId(){
        ...
        Assert.assertEquals(petApiWrapper.getPostPetResponseStatus(), HttpStatus.SC_OK, "The pet tag id "
    ...
    private void VerifyErrorWhenCreatingAPetWithEmptyTagName(){
        ...
        Assert.assertEquals(petApiWrapper.getPostPetResponseStatus(), HttpStatus.SC_OK, "The pet tag name " +
    ...
    private void VerifyErrorWhenCreatingAPetWithInvalidAlphabeticCharactersStatus(){
        ...
        Assert.assertEquals(petApiWrapper.getPostPetResponseStatus(), HttpStatus.SC_NOT_FOUND, "The pet status " + postResponsePet.getStatus()
                + ", is invalid");
    }
    ...
    private void VerifyErrorWhenCreatingAPetWithEmptyStatus(){
        ...
        Assert.assertEquals(petApiWrapper.getPostPetResponseStatus(), HttpStatus.SC_BAD_REQUEST, "The pet status " + postResponsePet.getStatus()
                + ", is empty");
    }
    ...
    private void VerifyErrorWhenCreatingAPetWithEmptyData(){
        ...
        Assert.assertEquals(petApiWrapper.getPostPetResponseStatus(), HttpStatus.SC_OK, "The pet data " + postResponsePet.getStatus()
                + ", is empty");
    }
}
