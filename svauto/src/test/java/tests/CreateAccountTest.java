...
public class CreateAccountTest extends BaseTest {
    ...
    public void testEmptyEmail() {
        ...
        Assert.assertEquals(this.createAccountPage.getSignUpErrorMsg(), INVALID_EMAIL_ERROR, "[Create Account Page] " +
    ...
    public void testExistingEmail() {
        ...
        this.createAccountPage.verify();
        Assert.assertTrue(this.createAccountPage.getSignUpError(), "[Create Account Page] Error message is displayed");
        Assert.assertEquals(this.createAccountPage.getSignUpErrorMsg(), EXISTING_EMAIL_ERROR, "[Create Account Page] " +
    ...
    public void testCreateAccountEmptyData() {
        ...
        Assert.assertEquals(this.registerAccountPage.getRegisterAccountErrorMsg(), EMPTY_ACCOUNT_DATA, "[Register Account Page] " +
