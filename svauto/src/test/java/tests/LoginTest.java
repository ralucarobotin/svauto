...
public class LoginTest extends BaseTest {
  ...
  public void testEmptyCredentials() {
    ...
    Assert.assertEquals(this.loginPage.getLoginErrorMsg(), EMPTY_CREDENTIALS_ERROR, "[Login Page] Received text error " +
  ...
  public void testEmptyPassword() {
    ...
    this.loginPage.verify();
    Assert.assertTrue(this.loginPage.getLoginError(), "[Login Page] Error message is displayed");
    Assert.assertEquals(this.loginPage.getLoginErrorMsg(), EMPTY_PSW_ERROR, "[Login Page] Received text error" +
  ...
  public void testInvalidEmailFormat() {
    ...
    this.loginPage.verify();
    Assert.assertTrue(this.loginPage.getLoginError(), "[Login Page] Error message is displayed");
    Assert.assertEquals(this.loginPage.getLoginErrorMsg(), INVALID_EMAIL_ERROR, "[Login Page] Received text error" +
  ...
  public void testInvalidPassword() {
    ...
    this.loginPage.verify();
    Assert.assertTrue(this.loginPage.getLoginError(), "[Login Page] Error message is displayed");
    Assert.assertEquals(this.loginPage.getLoginErrorMsg(), INVALID_CREDENTIALS_ERROR, "[Login Page] Received text error" +
